...
slug: intro-linux
section: guides
path: guides/intro-linux
tags: [linux, beginner]
created: 2026-05-01
updated: 2026-06-01
summary: where to start with a fresh shell and not get overwhelmed
suggested: true
---
...
if a command fails, read the error before retrying. it is almost always telling you exactly what's wrong.
